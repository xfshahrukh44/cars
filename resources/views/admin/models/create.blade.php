...
@section('title', isset($attribute->id) ? 'Edit Location' : 'Add Model')
@section('section')
    <style>
        .switch {
            position: relative;
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="attribute-form" method="post" action="{{ route('admin.models.store') }}" enctype="multipart/form-data">
                                  {{-- route('catalog.editModel', $attribute->id) --}}
                                @csrf
                                <div class="card-body">
