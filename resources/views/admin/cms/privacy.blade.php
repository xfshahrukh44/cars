                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Privacy</a></li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Privacy Form</h3>
                            </div>
                            <form class="category-form" method="post" action="{{route('admin.cms.privacy')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="name">Privacy Content</label>
                                            <textarea id="editor" class="form-control" name="privacy_content" cols="30" rows="10">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var content = '{!! $data->privacy_content !!}';
