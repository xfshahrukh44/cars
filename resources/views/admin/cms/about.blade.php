                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <textarea class="form-control" name="section_1_description" rows="4" required
                                                      >{{$data->section_1_description}}</textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name">Description</label>
                                            <textarea class="form-control" name="section_2_description" rows="4" required
                                            >{{$data->section_2_description}}</textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name">Title 2</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name">Description</label>
                                            <textarea class="form-control" name="section_3_description" rows="4" required
                                            >{{$data->section_3_description}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name">Description</label>
                                            <textarea class="form-control" name="section_4_description" rows="4" required
                                            >{{$data->section_4_description}}</textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name">Title 2</label>
